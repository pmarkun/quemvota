...
from quiz.chefeExecutivos import ImportadorChefesExecutivos
import re
import sys
import os
...
XML_FILE = 'dados/executivo.xml'
NOME_CURTO = 'cmsp'

# arquivos com os dados fornecidos pela cmsp
XML2012 = os.path.join(MODULE_DIR, 'dados/VOTACOES_2012.xml')
XML2013 = os.path.join(MODULE_DIR, 'dados/VOTACOES_2013.xml')
XML2014 = os.path.join(MODULE_DIR, 'dados/VOTACOES_2014.xml')
XML2015 = os.path.join(MODULE_DIR, 'dados/VOTACOES_2015.xml')
XML2016 = os.path.join(MODULE_DIR, 'dados/VOTACOES_2016.xml')
